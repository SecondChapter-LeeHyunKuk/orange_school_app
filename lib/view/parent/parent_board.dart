...
class ParentBoard extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => _ParentBoard();
}

class _ParentBoard extends State<ParentBoard> {
  ...
  Future<Response> getFirst() async {
    var response = await apiRequestGet(context, urlSearch,  {"size" : "20","sort" : ["number,DESC"],"pickType" : "PARENT"});
  ...
  Future<void> scroll() async {
    var response = await apiRequestGet(context, urlSearch,  {"size" : "20", "sort" : ["number,DESC"], "page" : (index + 1).toString(),"pickType" : "PARENT"});
    var body =jsonDecode(utf8.decode(response.bodyBytes));
