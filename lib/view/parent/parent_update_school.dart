...
class ParentUpdateSchool extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ParentUpdateSchool();
}

class _ParentUpdateSchool extends State<ParentUpdateSchool> {
  ...
  Widget build(BuildContext context) {
    if(childInfo == null){
      childInfo = ModalRoute.of(context)?.settings.arguments as Map;
