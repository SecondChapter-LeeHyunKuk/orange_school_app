...
class _ParentChallenge extends State<ParentChallenge> {
  ...
  List completeList = [];
  Future<http.Response>? getChildrenResult;
                                              ...
                                              ClipRRect(
                                                  ...
                                                  CachedNetworkImage(imageUrl:
                                                    ...
                                                    errorWidget: (context, url, error) {
                                                      return SvgPicture.asset("assets/icons/profile_${children[selectedChildIndex]["id"]%3 + 1}.svg",width: 36, height: 36, );
                                ...
                                if (snapshot.connectionState != ConnectionState.done){
                                  ...
                                  if(ongoingChallenge != null){
                                          ...
                                          child: Container(
                                            ...
                                            child: Stack(
                                              ...
                                              children: [
                                                ...
                                                Positioned(right: 16, top: 24,child:


                                                GestureDetector(
                                                    behavior: HitTestBehavior.translucent,
                                                    onTap: (){
                                                      Navigator.pushNamed(context,'/parent/challenge/update', arguments:ongoingChallenge!)

                                                          .then((value){
                                                        getOngoingChallenge = null;
                                                    ...
                                                    Container(
                                                      ...
                                                      alignment: Alignment.center,
                                                      child: SvgPicture.asset("assets/icons/ic_16_edit.svg", width: 16, height: 16,),
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    GestureDetector(
                                                      onTap: (){
                                                        if(index+1 <= ongoingChallenge!["currentStampCount"]){
                                                          showDialog(
                                                            context: context,
                                                            builder: (BuildContext context) {
                                                              return Alert(title: "도장을 회수하시겠어요?");
                                                            },
                                                          )
                                                              .then((val) {
                                                            if (val != null) {
                                                          ...
                                                          if(ongoingChallenge!["requiredOrangeCount"] != ongoingChallenge!["currentOrangeCount"]) {
                                                            showDialog(
                                                              context: context,
                                                              builder: (BuildContext context) {
                                                                return Alert(title: "아이에게 도장을 주시겠어요?");
                                                              },
                                                            )
                                                                .then((val) {
                                                              if (val != null) {
                                                ...
                                                child: ElevatedButton(
                                                  ...
                                                  onPressed: () {
                                                    showDialog(
                                                      context: context,
                                                      builder: (BuildContext context) {
                                                        return Alert(title: "챌린지를 완료하시겠어요?");
                                                      },
                                                    )
                                                        .then((val) {
                                                      if (val != null) {
                                                  ...
                                                  child: Text("챌린지 완료하기", style: MainTheme.body4(MainTheme.mainColor),),
                                                ),
                                              ) : SizedBox.shrink()
                                            ],
                                          ),
                                    ...
                                    return GestureDetector(
                                      onTap: (){Navigator.pushNamed(context,'/parent/challenge/create', arguments:children[selectedChildIndex]["id"]).then((value) => setState((){getOngoingChallenge = getOngoing();}));},
                                      behavior: HitTestBehavior.translucent,
                                      child: DottedBorder(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    Text("진행중인 챌린지가 없어요!", style: MainTheme.body2(MainTheme.gray6),),
                                                    Text("챌린지를 생성하여 아이와\n습관만들기를 시작하세요", style: MainTheme.body9(MainTheme.gray5),)
                                                  ],
                                                )
                                              ],
