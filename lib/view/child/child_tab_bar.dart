...
import 'package:orange_school/view/child/child_board.dart';
...
import 'child_challenge.dart';
import 'child_my.dart';
import 'child_plan.dart';


String urlPopup = "${dotenv.env['BASE_URL']}user/popups";
class ChildTabBar extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ChildTabBar();
}

class _ChildTabBar extends State<ChildTabBar>
