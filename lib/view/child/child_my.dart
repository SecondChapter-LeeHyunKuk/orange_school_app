...
class _ChildMy extends State<ChildMy> {
        ...
        Container(
          ...
          Column(
            ...
            children: [
              ...
              onTap: (){Navigator.of(context).pushNamed('/child/update').then((value) => getMy());},
                child:
              IntrinsicWidth(
                child: Row(
              ...
              Row(
                ...
                children:[
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){}, child: Text("친구초대", style: MainTheme.body4(MainTheme.subColor),),)
                  )
              ...
              GestureDetector(
                behavior: HitTestBehavior.translucent,
                onTap: (){Navigator.of(context).pushNamed('/child/update/school');},
                child:
              Text("학교 관리", style: MainTheme.body4(MainTheme.gray7)),),
              SizedBox(height: 34,),
              GestureDetector(
                behavior: HitTestBehavior.translucent,
