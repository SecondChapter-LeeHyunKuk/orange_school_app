...
class Alarm extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Alarm();
}
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child:  AppBar(
          ...
          title: Text("알림", style:MainTheme.body5(MainTheme.gray7)),
        ),),
      backgroundColor: Colors.white,
      body:
                                ...
                                ...List.generate(list.length, (index) =>
                                    ...
                                    GestureDetector(
                                      ...
                                      onTap: (){
                                        ...
                                        Navigator.of(context).pushNamed("/alarm/detail", arguments: list[index]);
                                      ...
                                      child: Container(
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            list[index]["alarmType"] == "SYSTEM" ? Container(
                                              margin: EdgeInsets.only(bottom: 5),
                                              child: Text("서비스 알림", style: TextStyle(fontWeight: FontWeight.w700, fontFamily: "SUIT", fontSize: 13,color: MainTheme.gray5, letterSpacing: 0)),
                                            ) : SizedBox.shrink(),
                                            Row(
