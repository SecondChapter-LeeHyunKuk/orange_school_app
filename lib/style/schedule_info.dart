...
class ScheduleInfo extends StatefulWidget {
  ...
  const ScheduleInfo ({ Key? key, required this.scheduleId , required this.calendarId }): super(key: key);
  @override
  _ScheduleInfo createState() => _ScheduleInfo();
}

class _ScheduleInfo extends State<ScheduleInfo> {
